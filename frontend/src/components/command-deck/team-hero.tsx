...
/**
 * TeamHero — Team Intelligence's opening instrument, same real-atmosphere technique as
 * `CompetitionHero`: stadium-lighting glow blobs + a faint telemetry grid stand in for "knowledge
 * graph animation," and this page's own already-fetched club crests drift faintly in the backdrop
 * as the brief's "club silhouettes" — real assets, never stock imagery.
 */
export function TeamHero({
  ...
  sport: SportMeta
  /** Omitted on sport-scoped routes (e.g. `/app/football/teams`) — SportShell already owns sport
   * switching there, so the segmented control only renders when a handler is supplied. */
      ...
      <div className="relative flex flex-col gap-6">
        <div>
          ...
          <p className="mt-2.5 max-w-xl font-[var(--cd-font-body)] text-[13.5px] leading-relaxed sm:text-[15px]" style={{ color: 'var(--cd-text-secondary)' }}>
            Explore every club monitored by TitanIQ's AI Intelligence Engine.
          </p>
        </div>
